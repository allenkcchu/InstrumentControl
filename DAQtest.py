...
ai = AIVoltageChan(ai_param=AIParameters(rate, N, ['/Dev1/ai0','/Dev1/ai1']), terminalConfig='DAQmx_Val_Diff', trigger=None)
# ai = AIVoltageChan(ai_param=AIParameters(rate, N, ['/SimDev1/ai1']), terminalConfig=nidaq.DAQmx_Val_Diff, trigger=None)
ai.start()
ai.wait()
data = ai.read()
ai.stop()
