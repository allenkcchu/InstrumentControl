# -*- coding: utf-8 -*-
"""
Created on Mon Jun 20 18:23:33 2022
...
def ws_create_waveshaper(name, wsconfig):
	...
	return (wsapi.ws_create_waveshaper(p, wsconfig), p.raw.strip(b"\x00"))		
